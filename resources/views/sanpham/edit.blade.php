            ...
            <div class="card-body">
                ...
                <form action="{{ route('sanpham.update', $sanpham->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('ten') is-invalid @enderror" 
                                       id="ten" name="ten" value="{{ old('ten', $sanpham->ten) }}" 
                                ...
                                <select class="form-select @error('loai_san_pham_id') is-invalid @enderror" 
                                    ...
                                    @foreach ($loaiSanPhams as $loai)
                                        <option value="{{ $loai->id }}" 
                                                {{ old('loai_san_pham_id', $sanpham->loai_san_pham_id) == $loai->id ? 'selected' : '' }}>
                                            {{ $loai->ten_loai }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control @error('gia') is-invalid @enderror" 
                                           id="gia" name="gia" value="{{ old('gia', $sanpham->gia) }}" 
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="hinh_anh" class="form-label">
                                    <i class="ri-image-line me-1"></i>Hình ảnh mới
                                </label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">
                                        <i class="ri-image-2-line me-1"></i>Hình ảnh hiện tại
                                    </label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('sku') is-invalid @enderror" id="sku" name="sku" value="{{ old('sku', $sanpham->sku) }}" placeholder="SKU...">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('so_luong_ton_kho') is-invalid @enderror" id="so_luong_ton_kho" name="so_luong_ton_kho" value="{{ old('so_luong_ton_kho', $sanpham->so_luong_ton_kho) }}" min="0">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('trong_luong') is-invalid @enderror" id="trong_luong" name="trong_luong" value="{{ old('trong_luong', $sanpham->trong_luong) }}">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('kich_thuoc') is-invalid @enderror" id="kich_thuoc" name="kich_thuoc" value="{{ old('kich_thuoc', $sanpham->kich_thuoc) }}" placeholder="Dài x Rộng x Cao">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('mau_sac') is-invalid @enderror" id="mau_sac" name="mau_sac" value="{{ old('mau_sac', $sanpham->mau_sac) }}">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('chat_lieu') is-invalid @enderror" id="chat_lieu" name="chat_lieu" value="{{ old('chat_lieu', $sanpham->chat_lieu) }}">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('hang_san_xuat') is-invalid @enderror" id="hang_san_xuat" name="hang_san_xuat" value="{{ old('hang_san_xuat', $sanpham->hang_san_xuat) }}">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('xuat_xu') is-invalid @enderror" id="xuat_xu" name="xuat_xu" value="{{ old('xuat_xu', $sanpham->xuat_xu) }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('gia_goc') is-invalid @enderror" id="gia_goc" name="gia_goc" value="{{ old('gia_goc', $sanpham->gia_goc) }}" min="0" step="1000">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('tinh_trang') is-invalid @enderror" id="tinh_trang" name="tinh_trang">
                                    <option value="1" {{ old('tinh_trang', $sanpham->tinh_trang) == 1 ? 'selected' : '' }}>Còn hàng</option>
                                    <option value="0" {{ old('tinh_trang', $sanpham->tinh_trang) == 0 ? 'selected' : '' }}>Hết hàng</option>
                                </select>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('mo_ta_chi_tiet') is-invalid @enderror" id="mo_ta_chi_tiet" name="mo_ta_chi_tiet" rows="3" placeholder="Nhập mô tả chi tiết...">{{ old('mo_ta_chi_tiet', $sanpham->mo_ta_chi_tiet) }}</textarea>
                    ...
                    <div class="d-flex gap-2 justify-content-end">
                        ...
                        <button type="submit" class="btn btn-info">
                            <i class="ri-save-line me-1"></i>Cập nhật sản phẩm
                        </button>
                    </div>
                </form>
            </div>
    ...
    document.getElementById('hinh_anh').addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                // Tạo preview image mới nếu chưa có
                let preview = document.getElementById('new-image-preview');
                if (!preview) {
                    const previewContainer = document.createElement('div');
                    previewContainer.className = 'mt-2';
                    previewContainer.innerHTML = `
                        <small class="text-muted d-block mb-1">Preview hình ảnh mới:</small>
                        <img id="new-image-preview" class="img-thumbnail" style="max-width: 200px; max-height: 200px; object-fit: cover;">
                    `;
                    document.getElementById('hinh_anh').parentNode.appendChild(previewContainer);
                    preview = document.getElementById('new-image-preview');
                }
